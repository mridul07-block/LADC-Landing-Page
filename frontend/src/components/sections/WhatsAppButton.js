    ...
    <TooltipProvider>
      <Tooltip>
        <TooltipTrigger asChild>
          <a
            href="https://wa.me/919620499988"
            target="_blank"
            rel="noopener noreferrer"
            className="fixed bottom-20 right-4 z-50 w-14 h-14 rounded-full flex items-center justify-center transition-transform duration-200 hover:scale-110 focus-coral"
